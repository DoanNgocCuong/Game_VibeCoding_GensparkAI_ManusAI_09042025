            ...
            topTags.map(tagName => {
              ...
              return (
                <div
                  ...
                  style={{
                    borderLeftColor: tags[tagName] ? tags[tagName].color : '#CBD5E0',
                  }}
                >
                  <div className="flex justify-between items-center">
                    <span
                      className="tag-pill"
                      style={{
                        backgroundColor: tags[tagName] ? `${tags[tagName].color}33` : '#CBD5E033',
                  ...
                  <div className={`mt-2 ${stats.totalValue >= 0 ? 'text-green-600' : 'text-red-600'} font-bold`}>
